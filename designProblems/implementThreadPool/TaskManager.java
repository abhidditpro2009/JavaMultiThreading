...
public class TaskManager implements Runnable, TaskManagerInterface {
	...
	public  void stopTask(){
		...
		if(!currentTask.isCompleted) {
			System.out.println(
					this.currentThread.getName() + " executing task " + currentTask.getName() +
							" is being gracefully stopped.");
		} else {
			System.out.println(this.currentThread.getName() +
					" waiting for new tasks is being gracefully stopped.");
		}
	}
	...
	public void cancelTask(){
		...
		if(!currentTask.isCompleted) {
			System.out.println(
					this.currentThread.getName() + " executing task " + currentTask.getName() +
							" is being forcefully stopped.");
		} else {
			System.out.println(this.currentThread.getName() +
					" waiting for new tasks is being forcefully stopped.");
		}
